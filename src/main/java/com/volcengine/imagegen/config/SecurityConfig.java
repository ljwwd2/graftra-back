    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        // Public endpoints
                        .requestMatchers("/api/auth/register", "/api/auth/login", "/api/auth/wechat", "/api/auth/captcha", "/api/auth/verify-captcha", "/api/auth/health", "/api/auth/send-sms", "/api/auth/send-reset-sms", "/api/auth/reset-password").permitAll()
